...
public final class RockstarHandler extends AbstractHandler {
	...
	public void handle(String target, Request baseRequest, HttpServletRequest request,
		...
		if (path.startsWith("/execute")) {
			System.out.println("Processor captured "+baseRequest.getPathInContext() + ", ?: "+baseRequest.getQueryString());
			...
			System.out.println("Processor passed "+baseRequest.getPathInContext() + ", ?: "+baseRequest.getQueryString());
		}
	}
	...
	private String run(String source, String input) throws IOException {
	    ...
	    api.getEnv().getOutput().println("test ");
